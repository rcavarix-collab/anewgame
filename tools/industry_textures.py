#!/usr/bin/env python3
"""Generates assets/textures/parked/industry.vtex: the Voxistics pulse-logistics set (parked in walkgrid M0.6).
...
so the sheen sits there; a ring marks each block's joint.
  ...
  python3 tools/industry_textures.py          # writes assets/textures/parked/industry.vtex
...
def main():
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "assets", "textures", "parked", "industry.vtex")
