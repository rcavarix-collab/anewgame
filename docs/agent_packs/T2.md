# walkgrid helper task T2 (pack made 2026-09-26)
...
### CLAUDE.md: the minimal text rule
...
Do task T2 as the Brief says: `REPORT.md` first, then each file under its `=== FILE:` line, and `END OF DELIVERY` at the very end.
