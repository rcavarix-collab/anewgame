...
| `research/` | Our research library (D66, D67): notes, an index (`research/README.md`) and a bibliography of legal copies; papers themselves aren't stored | When research is done or checked |
