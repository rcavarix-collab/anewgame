...
static const char* g_shaderSrc =
    ...
    // reaches. The sky is brightest around the sun, so a face turned toward
    // it gets more than one turned away, a gradient that keeps a hill's
    ...
    "    ambient += fSunColor.rgb * (0.12f * toSun * toSun + 0.25f * groundLit * saturate(0.5f - 0.5f * n.y));\n"
