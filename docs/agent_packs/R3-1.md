**Part 1 of 2** of walkgrid helper task R3. More parts follow: don't start the task yet. Reply only `got part 1 of 2`.

# walkgrid helper task R3 (pack made 2026-09-26)
