...
const char* ProfCounterName(ProfCounter c) {
    static const char* names[PCOUNT_COUNT] = {
        "CHUNKS RESIDENT", "CHUNKS DRAWN", "TRIANGLES", "MESHES BUILT", "DIRTY WAITING", "COLUMNS WAITING", "COLUMNS GENERATING", "MESHES BUILDING", "UPDATES WAITING", "SHADOW RENDERS", "CHUNKS HIDDEN",
    };
    return names[c];
}
