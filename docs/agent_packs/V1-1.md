**Part 1 of 2** of walkgrid helper task V1. More parts follow: don't start the task yet. Reply only `got part 1 of 2`.

# walkgrid helper task V1 (pack made 2026-09-26)
