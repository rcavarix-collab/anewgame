**Part 3 of 3, the last** of walkgrid helper task R1. You now have everything (read it together with the earlier parts): do the task.

### render.cpp: world shader lighting (a string of HLSL)
...
Do task R1 as the Brief says: `REPORT.md` first, then each file under its `=== FILE:` line, and `END OF DELIVERY` at the very end.
