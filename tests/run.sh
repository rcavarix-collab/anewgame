...
python3 ../tools/check_strings.py  # every player-facing word in the string table (D26)
...
g++ -std=c++17 -O1 -Wall -Wextra -pthread -Istub -I.. \
    ...
    ../music_synth.cpp ../sfx_synth.cpp ../soundscape.cpp ../facetmesh.cpp ../groundmesh.cpp ../collide.cpp ../strtable.cpp \
    -o "$OUT"
"$OUT"
